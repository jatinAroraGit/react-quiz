        ...
        {location && (
          <div>
            ...
            >
              ...
              <li>
                Max temp:{" "}
                {Math.round(location.consolidated_weather[0].max_temp * 100) /
                  100}
              </li>
              <li>
                Max temp:{" "}
                {Math.round(location.consolidated_weather[0].min_temp * 100) /
                  100}
              </li>
              <li>Humidity: {location.consolidated_weather[0].humidity}</li>
              <li>
                Visibility:{" "}
                {Math.round(location.consolidated_weather[0].visibility * 100) /
                  100}
              </li>
              <li>
                Wind Speed:{" "}
                {Math.round(location.consolidated_weather[0].wind_speed * 100) /
                  100}
              </li>
            </div>
          </div>
